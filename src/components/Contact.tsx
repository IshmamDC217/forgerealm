      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div>
            ...
            <p className="mt-3 text-[color:var(--fg)]/70">Have a design, concept, or a project idea? Let’s talk.</p>

            <div className="mt-8 space-y-3 text-sm text-[color:var(--fg)]/70">
            ...
            <div className="mt-8 rounded-2xl border border-[color:var(--border)] bg-[color:var(--surface)] p-6 backdrop-blur-xl hover:bg-white/10 hover:border-blue-400 transition">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 text-sm text-[color:var(--fg)]/70">
                <div>Mon–Fri</div>
                <div>08:00–18:00</div>
                <div>Saturday</div>
                <div>10:00–16:00</div>
          ...
          <div className="flex flex-col items-center justify-center text-center">
            <h2 className="text-3xl sm:text-4xl font-display font-extrabold text-[color:var(--fg)] max-w-[28rem]">
            ...
            <a href="mailto:forgerealmltd@gmail.com">
              <button className="relative inline-flex h-12 w-60 overflow-hidden rounded-lg p-[1px] focus:outline-none group">
                ...
                {/* Inner button */}
                <span className="email-cta inline-flex h-full w-full items-center justify-center rounded-lg bg-[#0b0b0e] px-7 text-sm font-semibold text-[color:var(--fg)] backdrop-blur-3xl transition group-hover:bg-[#101018] gap-2 border border-white/40">
                  Send an Email
                  <FaEnvelope className="text-blue-400" />
                </span>
              </button>
            ...
            <p className="mt-6 text-xs text-[color:var(--fg)]/60">We usually respond within 24 hours on working days.</p>
          </div>
        </div>
      </div>
    </section>
